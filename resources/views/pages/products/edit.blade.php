                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control" required>
                                        ...
                                        @endforeach
                                        <option @if ($product->category_id == "0") selected @endif value="0">{{ __('lang.others') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="brand_id" id="brand_id" class="form-control" required>
                                        ...
                                        @endforeach
                                        <option  @if ($product->brand_id == "0") selected @endif value="0">{{ __('lang.others') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="unit_id" id="unit_id" class="form-control" required>
                                        ...
                                        @foreach($units as $unit)
                                            <option  @if ($product->unit_id === $unit->id) selected @endif value="{{ $unit->id }}">{{ $unit->unit }} ({{ $unit->prefix }})</option>
                                        @endforeach
                                        <option  @if ($product->unit_id == "0") selected @endif value="0">{{ __('lang.others') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit_value" id="unit_value" value="{{ $product->unit_value }}" class="form-control" required>
                                </div>
                            </div>
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" name="allow_add_to_cart_when_out_of_stock" value="1"
                                                   id="checkbox1"  @if ($product->allow_add_to_cart_when_out_of_stock) checked @endif class="form-check-input">
                                            <label
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" name="is_active" value="1"
                                                   id="checkbox2"  @if ($product->is_active) checked @endif class="form-check-input">
                                            <label
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" name="apply_discount" value="1" id="apply_discount"
                                                   class="form-check-input" @if ($product->apply_discount) checked @endif>
                                            <label
                                                for="apply_discount">{{ __('lang.apply_discount') }}</label>
                                        </div>
                                        <div class="row @if ($product->apply_discount) d-block @else d-none @endif" id="discount-section">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="discount_type" id="discount_type"
                                                            class="form-control">
                                                        <option value="">{{ __('lang.select_option') }}</option>
                                                        <option @if($product->discount_type === 'percentage') selected @endif  value="percentage">{{ __('lang.percentage') }}</option>
                                                        <option @if($product->discount_type === 'value') selected @endif value="value">{{ __('lang.value') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="discount_value" id="discount_value"
                                                           class="form-control" data-parsle-type="number" value="{{ $product->discount_value }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" name="is_everyday_essential" @if ($product->is_everyday_essential) checked @endif value="1"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea" rows="10" name="allergy_info">{{ $product->allergy_info }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="">{{ __('lang.storage_info') }}</label>
                                    <textarea class="form-control textarea" rows="10" name="storage_info">{{ $product->storage_info }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="">{{ __('lang.default_image') }}</label>
                                    <input type="file" name="default_image" id="default_image" class="dropify" data-default-file="{{ asset('/' . $product->default_image) }}">
                                </div>
                            </div>
