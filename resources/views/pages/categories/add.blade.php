...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('categories.store') }}" method="post" data-parsley-validate enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" id="" class="form-control">
                                        ...
                                        @foreach($categories as $category_obj)
                                            <option @if (isset($category->parent_id) && $category->parent_id === $category_obj->id) selected
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" name="is_nav" value="1"
                                                   id="checkbox1"  @if (isset($category->is_nav) && $category->is_nav) checked @endif class="form-check-input">
                                            <label
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" class="dropify" @if(isset($category->image) && $category->image)  data-default-file="{{ asset('/' . $category->image) }}" @else required @endif>
                                </div>
                            </div>
